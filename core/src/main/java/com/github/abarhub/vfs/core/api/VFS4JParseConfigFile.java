...
import com.github.abarhub.vfs.core.config.VFS4JClasspathParameter;
...
import com.github.abarhub.vfs.core.exception.VFS4JInvalideConfigFileException;
...
public class VFS4JParseConfigFile {

    private static final Logger LOGGER = VFS4JLoggerFactory.getLogger(VFS4JParseConfigFile.class);
    ...
    public VFS4JFileManagerBuilder parse(Properties properties) {
        VFS4JFileManagerBuilder fileManagerBuilder = new VFS4JFileManagerBuilder();
        ...
        for (String nom : liste) {
            ...
            if (map.containsKey(keyPath) || map.containsKey(keyMode)) {
                ...
                if (mode == VFS4JPathMode.STANDARD) {
                    ...
                    fileManagerBuilder.addPath(nom, new VFS4JPathParameter(Paths.get(""), readonly, VFS4JPathMode.TEMPORARY));
