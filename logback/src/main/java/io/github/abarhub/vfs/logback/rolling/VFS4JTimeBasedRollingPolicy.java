...
import io.github.abarhub.vfs.logback.rolling.helper.VFS4JRenameUtil;
...
public class VFS4JTimeBasedRollingPolicy<E> extends RollingPolicyBase implements TriggeringPolicy<E> {
    static final String FNP_NOT_SET = "The FileNamePattern option must be set before using TimeBasedRollingPolicy. ";
    // WCS: without compression suffix
    FileNamePattern fileNamePatternWithoutCompSuffix;

    private Compressor compressor;
    private VFS4JRenameUtil renameUtil = new VFS4JRenameUtil();
    ...
    VFS4JTimeBasedFileNamingAndTriggeringPolicy<E> timeBasedFileNamingAndTriggeringPolicy;
    ...
    public void start() {
        ...
        if (timeBasedFileNamingAndTriggeringPolicy == null) {
            timeBasedFileNamingAndTriggeringPolicy = new VFS4JDefaultTimeBasedFileNamingAndTriggeringPolicy<E>();
        }
    ...
    public void setTimeBasedFileNamingAndTriggeringPolicy(
            VFS4JTimeBasedFileNamingAndTriggeringPolicy<E> timeBasedTriggering) {
        this.timeBasedFileNamingAndTriggeringPolicy = timeBasedTriggering;
    }

    public VFS4JTimeBasedFileNamingAndTriggeringPolicy<E> getTimeBasedFileNamingAndTriggeringPolicy() {
